...
using ProductCatalogWebApi.Application.Validation;
...
using ProductCatalogWebApi.Repositories;
using ProductCatalogWebApi.Services;
using ProductCatalogWebApi.Validation;
using System.Text;
...
app.UseMiddleware<ProductCatalogWebApi.Middleware.ValidationErrorMiddleware>();
app.UseMiddleware<ProductCatalogWebApi.Middleware.GlobalExceptionMiddleware>();
